...
import org.opensearch.plugin.log10x.config.FlagsConfig;
...
/**
 * A class for creating L1es backed "multi_match" queries (OpenSearch variant).
 *
 * MultiMatchQueryBuilder is final in OpenSearch, so this class uses
 * AbstractQueryBuilder as a base and delegates to an internal
...
public class L1esMultiMatchQueryBuilder extends AbstractQueryBuilder<L1esMultiMatchQueryBuilder> {
	...
	public boolean lenient() { return lenient != null ? lenient : MatchQuery.DEFAULT_LENIENCY; }
	public MatchQuery.ZeroTermsQuery zeroTermsQuery() { return zeroTermsQuery; }
	...
	public L1esMultiMatchQueryBuilder zeroTermsQuery(MatchQuery.ZeroTermsQuery ztq) { this.zeroTermsQuery = ztq; return this; }
	...
	public L1esMultiMatchQueryBuilder cutoffFrequency(Float f) { /* removed, no-op */ return this; }
	...
	public static L1esMultiMatchQueryBuilder fromXContent(XContentParser parser, Client client) throws IOException {
		...
		MatchQuery.ZeroTermsQuery zeroTermsQuery = MatchQuery.ZeroTermsQuery.NONE;
